  ...
  methods: function (__superClass) {
    return {
      main :function _trc_Title_main() {
        ...
        _this.scrInit();
        _this.start=false;
        _this.actList=[new Tonyu.classes.kernel.Label({text: "ごりら",size: 300,fillStyle: Tonyu.globals.$fontColor,x: Tonyu.globals.$screenWidth*0.5,y: Tonyu.globals.$screenHeight*0.2,yureHaba: 300*0.01}),new Tonyu.classes.kernel.Label({text: "ver 1.1",size: 100,fillStyle: Tonyu.globals.$fontColor,x: Tonyu.globals.$screenWidth*0.5,y: Tonyu.globals.$screenHeight*0.32,yureHaba: 100*0.01}),new Tonyu.classes.kernel.Label({text: "画面タッチかクリックして",size: 80,fillStyle: Tonyu.globals.$fontColor,x: Tonyu.globals.$screenWidth*0.5,y: Tonyu.globals.$screenHeight*0.7,yureHaba: 80*0.01}),new Tonyu.classes.kernel.Actor({p: Tonyu.globals.$pat_saru,x: Tonyu.globals.$screenWidth*0.5,y: Tonyu.globals.$screenHeight*0.5,yureHaba: 300*0.01,scaleX: 0.5}),new Tonyu.classes.kernel.Label({text: "* 素材提供 *\n魔王魂 MidingerZ pixabay",size: 80,fillStyle: Tonyu.globals.$fontColor,x: Tonyu.globals.$screenWidth*0.5,y: Tonyu.globals.$screenHeight*0.8,yureHaba: 80*0.01})];
